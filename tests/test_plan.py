...
from courier_dispatch.tools.plan import register_tools, BEADS_INSTALL_MSG
...
class TestBeadsNotInstalled:
    ...
    @patch("courier_dispatch.tools.plan._beads_available", return_value=False)
...
class TestCreatePlan:
    @patch("courier_dispatch.tools.plan._beads_available", return_value=True)
    @patch("courier_dispatch.tools.plan._run_bd")
